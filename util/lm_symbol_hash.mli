 ...
 *)
val output_symbol        : Lm_printf.out_channel -> symbol -> unit
val output_symbol_list   : Lm_printf.out_channel -> symbol list -> unit
val output_symbol_set    : Lm_printf.out_channel -> SymbolSet.t -> unit
